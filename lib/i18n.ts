...
const strings = {
  en: {
    ...
    joinWithInvite: "Join with invite link or room ID",
    invitePlaceholder: "Paste invite link or 6-digit room ID",
    joinRoom: "Join Room",
    settings: "Settings",
    ...
    permissionsHelp: "Allow your microphone and camera before joining.",
    allowPermissions: "Allow camera and mic",
    ...
    codeHelpCreator: "Share the invite link and 4-digit code with one person.",
    ...
    subtitlePreview: "What the other person sees",
  ...
  ja: {
    ...
    joinWithInvite: "招待リンクまたはルームIDで参加",
    invitePlaceholder: "招待リンクまたは6桁のルームID",
    joinRoom: "ルームに参加",
    settings: "設定",
    ...
    permissionsHelp: "参加する前にマイクとカメラを許可してください。",
    ...
    codeHelpCreator: "招待リンクと4桁のコードを1人に共有してください。",
